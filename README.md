...
| AED <br/>RED | AED is a metric for measuring edit operations, used to calculate the average number of edits required to transform the generated name into the target name. RED is used in method name consistency detection scenarios, and, compared to absolute edit distance, RED better reflects the relative differences and improvements between the newly generated name and the original name. |
